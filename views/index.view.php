    ...
    <section class="contenedor-drinks" id="mojito">
      ...
      <div class="mw direction">
        <a href="drink?id=1"><button class="drinks-btn res">Ver Más</button></a>
        <div class="imagen">
        ...
        <div class="contenedor-texto">
          ...
          <a href="drink?id=1"><button class="drinks-btn res-desk">Ver Más</button></a>
        </div>
      </div>
    </section>
    <section class="contenedor-drinks" id="pina-colada">
      ...
      <div class="mw direction-reverse">
        <a href="drink?id=2"><button class="drinks-btn res">Ver Más</button></a>
        <div class="imagen">
        ...
        <div class="contenedor-texto">
          ...
          <a href="drink?id=2"><button class="drinks-btn res-desk">Ver Más</button></a>
        </div>
      </div>
    </section>
    <section class="contenedor-drinks" id="shots">
      ...
      <div class="mw direction">
        <a href="drink?id=16"><button class="drinks-btn res">Ver Más</button></a>
        <div class="imagen">
        ...
        <div class="contenedor-texto">
          ...
          <a href="drink?id=16"><button class="drinks-btn res-desk">Ver Más</button></a>
        </div>
      </div>
    </section>